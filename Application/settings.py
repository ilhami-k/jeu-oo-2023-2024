...
SUPER_BULLET_SPEED = 5
SUPER_BULLET_COOLDOWN = 50
SUPER_BULLET_LIFETIME = 125
SUPER_BULLET_DAMAGE = 3
SUPER_BULLET_RADIUS = 5
SUPER_BULLET_COLOR = (0,255,0)

# Sniper bullet settings
SNIPER_BULLET_SPEED = 15
SNIPER_BULLET_COOLDOWN = 100
SNIPER_BULLET_LIFETIME = 250
SNIPER_BULLET_DAMAGE = 5
SNIPER_BULLET_RADIUS = 7
